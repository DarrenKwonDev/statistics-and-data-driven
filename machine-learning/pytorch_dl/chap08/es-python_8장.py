...
train_dataset = datasets.ImageFolder(
    root=r"../chap08/data/archive/train", transform=train_transform
)
...
val_dataset = datasets.ImageFolder(
    root=r"../chap08/data/archive/test", transform=val_transform
)
...
class EarlyStopping:
    def __init__(
        self, patience=5, verbose=False, delta=0, path="../chap08/data/checkpoint.pt"
    ):
        self.patience = patience
